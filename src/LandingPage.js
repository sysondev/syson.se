  ...
  <>
    ...
    <IntroSection title="Fokus på dig" emoji={woman}>
      <p>
        ...
        platser. Säljarbete, administration och andra distraktioner kan du lägga
        åt sidan.
      </p>
      <p>
    ...
    <IntroSection title="Bäst, inte störst" emoji={house}>
      <p>
        ...
        jobbar i roller som utvecklare, testare, tech lead och scrum master. Men
        det är inte det som gör Syson speciellt.
      </p>
      <p>
        Vi är ett litet bolag och det tänker vi förbli. Vi är idag 16 personer.
        Några fler ska vi bli. Men inte många.
      </p>
      <p>
        Mycket blir bättre när man är mindre. Vi lär känna varandra bättre, det
        blir lättare att genomföra idéer och varje person blir lite viktigare.
      </p>
    </IntroSection>
    <Insta />
    <Contact />
